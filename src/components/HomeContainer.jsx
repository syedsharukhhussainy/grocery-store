  ...
  return (
    ...
    >
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
        ...
        <button
          type="button"
          className="bg-gradient-to-br from-orange-400 to-orange-500 w-full md:w-auto px-4 py-2  rounded-lg hover:shadow-lg transition-all text-white ease-in-out duration-100"
        >
          Order Now
        </button>
      </div>
        ...
        <div className="w-full h-full absolute top-0 left-0 flex items-center justify-center lg:px-36  py-4 gap-4 flex-wrap md:pt-10 ">
          {heroData &&
            heroData.map((n) => (
              <div
                key={n.id}
                className="lg:w-190 p-4 bg-cardOverlay h-56 backdrop-blur-md rounded-3xl flex flex-col items-center justify-center drop-shadow-lg"
              >
                <img
                  src={n.imageSrc}
